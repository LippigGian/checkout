          ...
          <div className="flex items-center justify-between w-full gap-2">
            <div className="flex items-center gap-5">
              ...
              <div className="flex flex-col  text-left ">
                <p className="primary ">Pagar con tarjeta</p>
                <p className=" text-leyenda">Crédito, débito y prepagas</p>
              </div>
            </div>
        ...
        <Button className="bg-white border text-dark shadow-md hover:bg-transparent w-auto h-auto p-5">
          <div className="flex items-center justify-between w-full gap-2">
            <div className="flex items-center gap-5">
              <CreditCard className="w-5 h-5" />
              <div className="flex flex-col  text-left ">
                <p className="primary ">Pagar con MODO</p>
                <p className=" text-leyenda">Con app Modo o app bancarias</p>
              </div>
            </div>
